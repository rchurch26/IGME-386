...
namespace Esri.ArcGISMapsSDK.Components
{
	...
	public class ArcGISCameraComponent : MonoBehaviour
	{
		...
		private void PushViewportProperties()
		{
			...
			if (lastVerticalFov != verticalFov || lastHorizontalFov != horizontalFov || lastViewportSizeX != viewportSizeX || lastViewportSizeY != viewportSizeY)
			{
				...
				if (viewportSizeX > 0 && viewportSizeY > 0 && horizontalFov > 0 && verticalFov > 0)
				{
					arcGISMapComponent.View.SetViewportProperties(viewportSizeX, viewportSizeY, horizontalFov, verticalFov, 1);
				}
			}
		}
