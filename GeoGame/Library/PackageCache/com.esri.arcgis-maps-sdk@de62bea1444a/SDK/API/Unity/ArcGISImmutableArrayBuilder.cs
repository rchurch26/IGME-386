...
namespace Esri.Unity
{
	public partial class ArcGISImmutableArrayBuilder<T>
	{
		...
		/// - Since: 100.9.0
		public Unity.ArcGISImmutableArray<T> MoveToArray()
		{
		...
		public ArcGISImmutableArrayBuilder(IntPtr handle)
		{
			intermediateImmutableArrayBuilder = new Standard.ArcGISIntermediateImmutableArrayBuilder<T>(handle);
		}
		...
		private Standard.ArcGISIntermediateImmutableArrayBuilder<T> intermediateImmutableArrayBuilder;
